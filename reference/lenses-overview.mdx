...
| DevOps Guidance Lens | 196 | 820 KB | CI/CD, automated governance, dev lifecycle |
| Machine Learning Lens | 35 | 852 KB | ML lifecycle, training/deployment, data engineering |
| Data Analytics Lens | 6 | 180 KB | Data pipelines, governance, catalogs |
| Games Industry Lens | 32 | 316 KB | Game backends, real-time multiplayer |
| SaaS Lens | 6 | 112 KB | Multi-tenancy, tenant isolation, onboarding |
| Financial Services Lens | 79 | 432 KB | FSI compliance, data residency, resilience |
| Life Sciences Lens | 56 | 468 KB | GxP, validated systems, clinical data |
| End User Computing Lens | 69 | 372 KB | Virtual desktops/apps, streaming, identity |
| Supply Chain Lens | 51 | 244 KB | Supply chain data, integration, traceability |
| Video Streaming & Advertising Lens | 43 | 296 KB | Video pipelines, ad tech, monetization |
| Telco Lens | 34 | 272 KB | Telecom, 5G/edge, OSS/BSS |
| SAP Lens | 6 | 380 KB | SAP on AWS, S/4HANA |
| Modern Industrial Data Technology Lens | 34 | 300 KB | Industrial data platforms, OT/IT |
| Microsoft Workloads Lens | 23 | 368 KB | Windows Server, SQL Server, .NET on AWS |
| Connected Mobility Lens | 6 | 284 KB | Connected vehicles, telematics, fleet data |
| Healthcare Industry Lens | 6 | 92 KB | HIPAA, clinical data, patient privacy |
| Container Build Lens | 6 | 76 KB | Container image builds, supply chain security |
| High Performance Computing Lens | 23 | 104 KB | HPC clusters, parallel workloads |
| Streaming Media Lens | 6 | 96 KB | Media streaming, live/VOD delivery |
| IoT Lens | 59 | 369 KB | IoT devices, telemetry, edge computing |
| Government Lens | 6 | 46 KB | Public sector, privacy-by-design, compliance |
