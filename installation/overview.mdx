---
title: "Installing Well-Architected Skills — All Methods"
sidebarTitle: "Overview"
description: "Three ways to add AWS Well-Architected skills: npx skills add, bootstrap scripts, or the local install script. Covers macOS, Linux, and Windows."
---
